...
const about = {
    ...
    info: [
        ...
        {
            fieldName: "Email",
            fieldValue: "Coding7enthusiast@gmail.com",
        },
        {
            fieldName: "Freelance",
        ...
        {
            fieldName: "Languages",
            fieldValue: "English, Hindi, Maithili",
        },
    ],
};
...
const experience = {
    ...
    items: [
...

        {
            ...
            position: "Software Company Startup",
            duration: "2023 - Present",
        },
    ],
};
...
const education = {
    ...
    items: [
        ...
        {
            institution: "C. M. Science College, Darbhanga, Bihar ",
                    ...
                    <div className="min-h-[70vh] w-full">
                        ...
                        <TabsContent value="experience" className="w-full">
                            <div className="flex flex-col gap-[30px] text-center xl:text-left ">
                                ...
                                <p className="max-w-[600px] text-white/60 mx-auto xl:mx-0">{experience.descreption}</p>
                        ...
                        <TabsContent value="education" className="w-full">
                            <div className="flex flex-col gap-[30px] text-center xl:text-left ">
                                ...
                                <p className="max-w-[600px] text-white/60 mx-auto xl:mx-0">{education.descreption}</p>
                                <ScrollArea className="h-[400px]">
                                    <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                        ...
                        <TabsContent value="skills" className="w-full h-full">
                            <div className="flex flex-col gap-[30px]">
                                <div className="flex flex-col gap-[30px] text-center xl:text-left">
                                    ...
                                    <p className="max-w-[600px] text-white/60 mx-auto xl:mx-0 ">{skills.descreption}</p>
                                </div>
                        ...
                        <TabsContent value="about" className="w-full text-center xl:text-left">
                            <div className="flex flex-col gap-[30px]">
                                ...
                                <p className="max-w-[600px] text-white/60 mx-auto xl:mx-0">{about.descreption}</p>
